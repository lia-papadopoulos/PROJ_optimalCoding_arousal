'''
example of how to load an .h5 file for one session in order to access data for 
creating .nwb files
'''
...
data_path = '/mnt/ion-nas2/Brain_Initiative/Neuropixels/Su_NP/processed_data_LP/'
