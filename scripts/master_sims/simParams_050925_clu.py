...
sim_params['simID'] = '050900002025_clu' 
...
# change standard deviation of external inputs without changing the mean
sim_params['pert_inputType'] = 'zeroMean_sd_pert'
sim_params['zeroMean_sd_nu_ext_ee'] = 0.0
sim_params['zeroMean_sd_pert_sameAllCluster'] = True
...
swept_param_name_dict['param_vals1'] = 'zeroMean_sd_nu_ext_ee'
...
sigmoid_arousal_dict['param_vals1'] = (0.9, 1.25, 0.275)
sim_params['sigmoid_arousal_dict'] = sigmoid_arousal_dict



#-----------------------------------------------------------------------------
# OTHER POTENTIAL PERTURBATIONS (DEFAULTS)
#----------------------------------------------------------------------------- 
# homogeneous inputs
...
sim_params['indNet_start'] = 1
# number of networks to run
sim_params['n_networks'] = 4
