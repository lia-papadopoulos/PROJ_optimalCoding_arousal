...
in this case, the background inputs to e and i cells were drawn from a uniform
distribution in the simulations; for the mft, use parameters that would just
correspond to a uniform mean increase
"""
...
# simulation ID
simID = '062620240956_2'    # cluster, reduce Jee recurrent, increase nu_ext_e uniform dist, nu_ext_i uniform dist, Jplus=15.75, 0.25, 3.5, 3.5
...
# sweep param name
sweep_param_name = 'Jee_reduction_nu_ext_e_uniform_spread_nu_ext_i_uniform_spread'
...
swept_params_dict = {}
swept_params_dict['param_vals1'] = np.linspace(0., 0.25, 9)
swept_params_dict['param_vals2']= np.linspace(0, 3.5, 9)
swept_params_dict['param_vals3'] = np.linspace(0, 3.5, 9)
...
Jee = s_params['Jee']
nu_ext_e_uniform_spread = s_params['nu_ext_e_uniform_spread']
nu_ext_i_uniform_spread = s_params['nu_ext_i_uniform_spread']
mean_nu_ext_e = s_params['mean_nu_ext_e']
mean_nu_ext_i = s_params['mean_nu_ext_i']

# set parameters for mft sweep
Jee_mft_low = Jee
nu_ext_e_mft_low = mean_nu_ext_e + nu_ext_e_uniform_spread/2
nu_ext_i_mft_low = mean_nu_ext_i + nu_ext_i_uniform_spread/2
...
s_params_mft['extCurrent_poisson'] = s_params['extCurrent_poisson']
...
s_params_mft['Cext'] = s_params['Cext'] 
s_params_mft['nu_ext_e'] = s_params['nu_ext_e']       
s_params_mft['nu_ext_i'] = s_params['nu_ext_i'] 
...
# set parameters for mft sweep
Jee_mft_high = Jee
nu_ext_e_mft_high = mean_nu_ext_e + nu_ext_e_uniform_spread/2
nu_ext_i_mft_high = mean_nu_ext_i + nu_ext_i_uniform_spread/2
