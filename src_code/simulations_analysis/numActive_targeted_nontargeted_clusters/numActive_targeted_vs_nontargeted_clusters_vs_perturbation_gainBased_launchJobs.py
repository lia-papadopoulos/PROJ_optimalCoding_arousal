...
import settings_file as params
...
for param_indx in range(0, nParam_vals):
    ...
    # COMMAND TO RUN
    command = "tsp python numActive_targeted_vs_nontargeted_clusters_vs_perturbation_gainBased.py --sweep_param_str_val %s " % (sweep_param_str)
