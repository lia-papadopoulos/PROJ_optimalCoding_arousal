...
#%% paths for loading and saving data; paths to functions
...
#%% whether or not to load simulation details from file

load_from_simParams = True
       
#%% if loading from simParams file, specify simParams_fname
