...
sim_params['simID'] = '041700002025_clu' 
...
#----------------------------------------------------------------------------------
# BASELINE AROUSAL PARAMETERS
# SETTING TO DEFAULT PARAMETERS (NO AROUSAL APPLIED)
# note that this case will differ slightly from the case of 0% arousal
#---------------------------------------------------------------------------------- 
...
#----------------------------------------------------------------------------- 
# JeePlus modulation
sim_params['JplusEE_sweep'] = 15.75

# number of parameters in arousal model
sim_params['nParams_sweep'] = 1

# names of parameters in arousal model
swept_param_name_dict = {}
swept_param_name_dict['param_vals1'] = 'JplusEE_sweep'
sim_params['swept_param_name_dict'] = swept_param_name_dict

# parameters for arousal variation
sim_params['arousal_variation'] = 'linear'
sim_params['arousal_levels'] = np.linspace(0,1,11)

# linear arousal dict: specify min and max values for each parameter in model
arousal_dict = {}
arousal_dict['param_vals1'] = (12, 19.5)
sim_params['linear_arousal_dict'] = arousal_dict
