...
from fcn_soundResp_cellSelection import fcn_soundResp_cellSelection
...
if globalPupilNorm == False:
    fname_end = '_soundResp_cellSelection'
else:
    fname_end = '_soundResp_cellSelection_globalPupilNorm'
...
for indSession, session_name in enumerate(all_sessions_to_run):
    ...
    cellSelection_inputParams = soundResp_params.parameters
    
    # run cell selection
    cellSelection_params, cellSelection_results = \
        fcn_soundResp_cellSelection(session_name, cellSelection_inputParams, processed_data_path) 
