...
from fcn_spkTemplate_soundResp_cellSelection import fcn_spkTemplate_soundResp_cellSelection
...
# import parameters
import params_spkTemplate_soundResp as params
...
if globalPupilNorm == False:
    fname_end = '_spkTemplate_soundResp_cellSelection1'
else:
    fname_end = '_spkTemplate_soundResp_cellSelection1_globalPupilNorm'
...
for indSession, session_name in enumerate(all_sessions_to_run):
    ...
    cellSelection_inputParams = params.parameters
    cellSelection_rawData_path = params.data_path[session_name]
    
    # run cell selection
    cellSelection_params, cellSelection_results = \
        fcn_spkTemplate_soundResp_cellSelection(session_name, cellSelection_inputParams, cellSelection_rawData_path, processed_data_path)    
