...
from fcn_rateDrift_cellSelection import fcn_rateDrift_cellSelection
...
if globalPupilNorm == False:
    fname_end = '_rateDrift_cellSelection'
else:
    fname_end = '_rateDrift_cellSelection_globalPupilNorm'
...
for indSession, session_name in enumerate(all_sessions_to_run):
    ...
    cellSelection_inputParams = rateDrift_params.parameters
    
    # run cell selection
    cellSelection_params, cellSelection_results = \
        fcn_rateDrift_cellSelection(session_name, cellSelection_inputParams, processed_data_path)    
