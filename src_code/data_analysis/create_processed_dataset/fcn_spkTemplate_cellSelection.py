...
changes from function I used:
        estimate sampling rate from time points
eventually remove good_units from output after checking consistency with my original method
'''
...
def fcn_spkTemplate_cellSelection(session_name, params, raw_data_path, processed_data_path):
    ...
    cell_spk_times_good = cell_spk_times_good[goodClusters_all]
    ...
    results['good_units'] = goodClusters_all
